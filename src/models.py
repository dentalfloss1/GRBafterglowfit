...
def get_tbreak(ivar, f0, nu0_1, nu0_2, nu0_3,k):
    k = args.k
    a1 = -k/(2*(4-k))
    b1 = -3*k/(5*(4-k))
    b2 = -3/2
...
def theory_bigsbpl(ivar, f0, nu0_1, nu0_2,nu0_3, k,jet_break=None, p=2.2,d=0.1,s=10):
    ...
    for tval,nuval in zip(t,nu):
        ...
        if jet_break is not None:
            ...
            if t_break < jet_break:
                ...
                Fbk2_tbreak = tsbpl(nuval,fpk2_break, nu_trans, nu_trans, nuc_trans, c1_2, c2_2, c3_2, c4_2) fnu_m_2 = f0*(tval/t0)**a1_2 fpk_2 = fnu_m_2*(num_2/nua_2)**(3)
...
def wrap_forward(ivar, f0,nu01,nu02,nu03,jet_break=None,p=2.2):
    s = 5
    d = 0.2
    k=args.k
    t, nu = ivar
    res = []
    f = theory_bigsbpl(ivar, f0, nu01, nu02, nu03,k,jet_break,p)
    return f
